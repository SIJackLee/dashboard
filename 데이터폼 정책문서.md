...
> **현행 (펌웨어):** wire `ver=0x07` / `lut_ver=8` — [명세](../docs/changes/20260610-wire-v007-spec.md)  
> **이전:** `ver=0x06` — [명세](../docs/changes/20260610-wire-v006-spec.md) · `ver=0x05` — [v005](../docs/changes/20260610-wire-v005-spec.md)  
> **레거시:** `P2T2F30` / `ver=0x03`·`0x04` / `lut_ver=7`  
...
| wire | JSON | 비고 |
|------|------|------|
| `stall_ty` 1~10 | `SP01`~`SP10` | 축종은 LUT `itemCode`로 추정 |
...
2. body CRC 검증
3. Header 파싱 (`ver=0x07`: reserved, `farm_uid` 없음)
