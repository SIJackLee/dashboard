...
> 앱 문서 진입점: [`../docs/README.md`](../docs/README.md) · 배포: [`../CLOUD_DEPLOY.md`](../CLOUD_DEPLOY.md)
...
| 파일 | 용도 |
|------|------|
| `farm-hub-url-manual-smoke.mjs` | 허브 URL·탭·soft home — `UI_VERIFY_BASE=…` · [`../docs/VERCEL_PREVIEW_GATE.md`](../docs/VERCEL_PREVIEW_GATE.md) |
