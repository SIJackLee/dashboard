...
const ROUTES = {
  admin: [
    ...
    { path: "/farm?tab=ops&panel=display", label: "컨트롤러·표시(→운영 리다이렉트)" },
    { path: "/settings", label: "설정(레거시)" },
    { path: "/admin/ops", label: "운영·시스템" },
    { path: "/admin/ops?tab=users", label: "운영·사용자" },
    { path: "/admin/ops?tab=farms", label: "운영·농장 메타" },
    { path: "/admin/ops?tab=display", label: "운영·표시" },
  ...
  operator: [
    ...
    { path: "/farm?tab=ops&panel=display", label: "컨트롤러·표시" },
    { path: "/farm?tab=ops&panel=farm", label: "컨트롤러·농장" },
