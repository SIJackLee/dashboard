...
const buttonVariants = cva(
  cn(
    ...
    motionClass.transitionColors,
    motionClass.transitionTransform,
    motionClass.durationFast,
  ),
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        dashboard:
          "h-12 min-h-12 gap-2 px-5 text-[1.75rem] font-medium leading-snug has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4 [&_svg:not([class*='size-'])]:size-5",
        icon: "size-8",
        "icon-xs":
