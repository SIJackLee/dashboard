...
관련: [`DECODED_CAPACITY.md`](./DECODED_CAPACITY.md) · [`IOT_RETENTION_OPTIONS.md`](./IOT_RETENTION_OPTIONS.md) · [`DECODED_JSON_SLIM.md`](./DECODED_JSON_SLIM.md)
...
다음: 희소 전 농장(`[]`) · archive 폐기 정책 · 월 파티션 자동 CREATE.
