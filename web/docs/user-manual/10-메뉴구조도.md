...
| 모델 | `view=model`. 위성 구획 → 1m 필드 → 새 건물 배치 → **배치 완료** 후 동은 세로로 세워 가로로 모이고, **축사 연결** / **컨트롤러 연결**, 우측 **축사 해제** / **컨트롤러 해제**(일괄). 생성에서 칸 색은 **알람 | 권장**(기본 알람). 옛 `view=plan`은 같은 탭. [`BARN_PLAN.md`](../BARN_PLAN.md) |
