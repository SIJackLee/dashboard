-- eqpmnEsntlSn: 자사 DB 미보유 — export 시 빈 문자열 (축평원 §2.1 빈값 "" 규칙)

-- v_ekape_export_row: eqpmn_esntl_sn 항상 '' (View 먼저 교체 후 함수 제거)
...
COMMENT ON VIEW public.v_ekape_export_row IS
  '축평원 v4.0 export — eqpmnEsntlSn 미보유(빈값); EC01~03 mesureVal01만';
